/**
 * REV: 06.13.16, HICi3-1.1.0-RC6-Bugfix, downloaded from Github archive.
 *
 * A custom configuration.h for HICTOP Reprap Prusa I3 "Ebay aluminum frame/Florida BB-8 Builders discount version"
 *
 * Major Changes and Updates from Marlin default:
 * 1) Motherboard type changed for 'red' HICTOP 'MPX.3' RAMPS 1.3 control board (Power Outputs: Extruder, Fan, Bed) = !check your verison!
 * 2) Enabled discount 4x20 LCD controller with rotary control
 * 3) EEPROM enabled
 * 4) SD card support debuged, need to continue testing
 *
 * Source files changed from original distro.  Original files names will follow with an *.orig tag:
 * - Configuration.h // this file
 * - Version.h // edited version file for reference
 *
 * All changes form original Marlin supplied source code is documented for this printer.
 * NOTE: to search for actual changes for my HICi3 printer changes here, search for 'CL:'
 *
 */
...
#define STRING_CONFIG_H_AUTHOR "(Chip L., HICTOP i3 Mendel v1.1.0-RC6)" // CL: updated info. Who made the changes.
...
// Port 0 used when using USB cable
...
#define CUSTOM_MACHINE_NAME "Piper V2.3" // CL: put version number on LCD menu
...
#define BED_MAXTEMP 120 // CL: lower for HIC i3, was =150
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 205 //CL HIC i3 actual X bed size 220mm, was =205
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT {80, 80, 2560,663.98} // PR: default steps for _my_ HIC i3, with Wade Geared extruder


#define DEFAULT_AXIS_STEPS_PER_UNIT {84.2105, 84.2105, 5120,733.24} // PAR: extruder steps for Piper printer with Wade Geared extruder and M8 z-lead screw with 400 steps/rev motors
                                                                    // PAR: Changed X  & Y steps/mm to 84.2105, assuming a 19 tooth pulley rather than 20
                                                                    // PAR: 88.8889 steps/mm if 18 teeth
...
#define DEFAULT_MAX_FEEDRATE {450, 450, 3, 25} // (mm/sec) CL: default HIC i3
...
#define DEFAULT_MAX_ACCELERATION {800, 600, 100, 10000} // (mm/sec^2) CL: default for HIC i3 - X, Y, Z, E(moves) maximum start speed for accelerated moves
...
#define DEFAULT_ACCELERATION          2000 // (mm/sec^2) CL: default for HIC i3 - X, Y, Z and E max acceleration for printing moves
...
#define DEFAULT_XYJERK                4.0 // (mm/sec) CL: new default for HIC i3, was =20
...
//                 https://github.com/olikraus/U8glib_Ard
// Uncomment ONE of the following items to use a slower SPI transferuino
//
...
//
//#define REPRAP_DISCOUNT_SMART_CONTROLLER // CL: Hici3 LCD default 20x4 Controller/Display, was =not enabled
